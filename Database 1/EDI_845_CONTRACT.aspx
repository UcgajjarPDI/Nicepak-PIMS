...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width:100%;"><tr><td><div style="text-align:right">
            <INPUT  type="button"  value="Contract" style="width:100px;font-family: Trebuchet MS, Arial, Helvetica, sans-serif;border:none;cursor:pointer;background-color:#A40000;color: WHITE;  " onClick="window.location='EDI_845_CONTRACT.aspx'"/>
            <INPUT id="3" type="button"  value="Price Authorization" style="width:125px;font-family: Trebuchet MS, Arial, Helvetica, sans-serif;border:none;cursor:pointer; color: #FFFFFF;background-color: #808080;" onClick="window.location='EDI_845_PRC_AUTH.aspx';" />
