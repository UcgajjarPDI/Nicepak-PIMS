...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <tr>
                <td>
                    <p class="pTitleStyles">
                        Sales Period:&nbsp  
                            <asp:DropDownList ID="DropDownExtender1" runat="server" AutoPostBack="true" 
                               ForeColor="#843C0C">
                            </asp:DropDownList>
                    </p>
                </td>
    ...
    <asp:Panel ID="Panel1"
        Height="500" Width="700" ClientIDMode="Static" runat="server" CssClass="modalPopup" align="left" Style="display: none; font-family: Helvetica;" ScrollBars="Auto">
        <p style="text-align: right;">
            <asp:ImageButton ID="Button1" runat="server" Height="15px" Width="15px" BorderStyle="None" ImageUrl="~/img/Cancle.Png" />
        </p>

        <ajaxToolkit:LineChart ID="LineChart1" runat="server" ClientIDMode="Static" ChartWidth="600" ChartHeight="550" EnableViewState="True"
