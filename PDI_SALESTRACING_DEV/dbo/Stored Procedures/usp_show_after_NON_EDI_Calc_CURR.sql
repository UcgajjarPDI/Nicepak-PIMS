CREATE  proc [dbo].[usp_show_after_NON_EDI_Calc_CURR] 
@vSalesPeriod varchar(10)
as
/*
sp_who

	exec usp_show_after_NON_EDI_Calc_Curr '20180901'
	exec usp_show_after_NON_EDI_Calc_Curr '20181001'
	...
	select distinct dist_id from [PDI_SALESTRACING_DEV].[STAGE].[SALES_TRACING_CURR]
