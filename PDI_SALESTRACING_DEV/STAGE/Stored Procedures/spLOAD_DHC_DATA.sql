...
TRUNCATE TABLE STAGE.DHC_COMPANY;
  ...
  INSERT INTO STAGE.DHC_COMPANY
    ...
    DHC_CO_CAT_CD, DHC_CO_SUB_CAT, DHC_NTWRK_ID, DHC_NTWRK_PARENT_ID, 
    DHC_CO_WEBSITE)
  SELECT DISTINCT 
    ...
    HOSPITAL_TYPE, NETWORK_ID, NETWORK_PARENT_ID, WEBSITE
  FROM STAGE.PDI_Hospitals
  ...
  MERGE [PDI_SALESTRACING_DEV].STAGE.DHC_COMPANY T
      ...
      SELECT DISTINCT 
        ...
        FIRM_TYPE AS DHC_CO_SUB_CAT, NETWORK_ID, NETWORK_PARENT_ID, WEBSITE
    ...
    WHEN NOT MATCHED BY TARGET THEN   -- That means it is a new Contract
      ...
      ( HOSPITAL_ID, HOSPITAL_NAME, HQ_ADDRESS, HQ_ADDRESS1, HQ_CITY, HQ_STATE, HQ_ZIP_CODE, CNTRY,
        DHC_CO_CAT_CD,DHC_CO_SUB_CAT, NETWORK_ID, NETWORK_PARENT_ID, WEBSITE);
