CREATE TABLE [STAGE].[TEMP_ADDR_LAUNDRY] (
    ...
    [ADRR3_TYP]     VARCHAR (100) NULL,
    [ADRR3_NR]      VARCHAR (100) NULL,
    [ALT_NM]        VARCHAR (150) NULL,
    [UPD_ADDR3]     VARCHAR (250) NULL,
    [ISSUE_CD]      VARCHAR (20)  NULL
);


GO
CREATE NONCLUSTERED INDEX [idx_Nonclustered_TEMP_ADDR_LAUNDRY_ID_SRCE_DATA_ID]
    ON [STAGE].[TEMP_ADDR_LAUNDRY]([ID] ASC, [SRCE_DATA_ID] ASC) WITH (FILLFACTOR = 100);
